...
//               /home/azc/Belgeler/dolunay/bd/cmod_a7_35t/ip/cmod_a7_35t_core_top_0_0/cmod_a7_35t_core_top_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "cmod_a7_35t_core_top_0_0,core_top,{}" *) (* CORE_GENERATION_INFO = "cmod_a7_35t_core_top_0_0,core_top,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=core_top,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,W_WRAM_ADDR=15,W_IROM_ADDR=12}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "core_top,Vivado 2025.2" *) 
module cmod_a7_35t_core_top_0_0(clk, rst_n, wram_clk_o, wram_addr_o, wram_wen_o, 
  wram_wdata_o, wram_rdata_i, irom_clk_a_o, irom_addr_a_o, irom_data_a_i, irom_clk_b_o, 
  irom_addr_b_o, irom_data_b_i)
/* synthesis syn_black_box black_box_pad_pin="rst_n,wram_addr_o[14:2],wram_wen_o[3:0],wram_wdata_o[31:0],wram_rdata_i[31:0],irom_addr_a_o[11:2],irom_data_a_i[31:0],irom_addr_b_o[11:2],irom_data_b_i[31:0]" */
...
/* synthesis syn_force_seq_prim="irom_clk_b_o" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clk, FREQ_HZ 12000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0" *) input clk /* synthesis syn_isclock = 1 */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 IROM_A ADDR" *) output [11:2]irom_addr_a_o;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 IROM_B ADDR" *) output [11:2]irom_addr_b_o;
