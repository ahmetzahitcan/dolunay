    ...
    always_comb begin
        case (imm_type_i) inside
            ...
            IMM_TYPE_B: begin 
                ...
                assert (imm_o[Z_PC-1:0] == 0) else $error("Branch immediate is not aligned to PC_ALIGN");
            end
            ...
            IMM_TYPE_J: begin
                ...
                assert (imm_o[Z_PC-1:0] == 0) else $error("Jump immediate is not aligned to PC_ALIGN");
            end
            default: imm_o = 'x;
        endcase
    end
