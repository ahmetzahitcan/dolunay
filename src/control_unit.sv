    ...
    always_comb begin
        ...
        case (undec_instr32_i) inside
            30'b001000000000000000000000000010: begin // YIELD
                ...
                instr_o.alu_cond = ALU_COND_UNDEFINED;
            ...
            30'b111100010100?????????????11100: begin // CSR_MHARTID
                ...
                instr_o.wb_source = WB_SOURCE_ALU_OUT;
                instr_o.branch = 1'b0;
                instr_o.binit = 1'b0;
                instr_o.bwait = 1'b0;
                instr_o.yield = 1'b0;
            ...
            30'b?????????????????000?????11000: begin // BEQ
                ...
                instr_o.alu_op1_sel = ALU_OP1_SEL_RS1;
                instr_o.alu_op2_sel = ALU_OP2_SEL_RS2;
                instr_o.alu_cond = ALU_COND_ZERO;
                instr_o.wb_active = 1'b0;
                instr_o.wb_source = WB_SOURCE_UNDEFINED;
                instr_o.branch = 1'b1;
                instr_o.binit = 1'b0;
            ...
            30'b?????????????????001?????11000: begin // BNE
                ...
                instr_o.alu_op1_sel = ALU_OP1_SEL_RS1;
                instr_o.alu_op2_sel = ALU_OP2_SEL_RS2;
                instr_o.alu_cond = ALU_COND_NONZERO;
                instr_o.wb_active = 1'b0;
                instr_o.wb_source = WB_SOURCE_UNDEFINED;
                instr_o.branch = 1'b1;
                instr_o.binit = 1'b0;
            ...
            30'b?????????????????000?????00000: begin // LB
                ...
                instr_o.alu_cond = ALU_COND_UNDEFINED;
                instr_o.wb_active = 1'b1;
                instr_o.wb_source = WB_SOURCE_MEM_OUT;
                instr_o.branch = 1'b0;
                instr_o.binit = 1'b0;
                instr_o.bwait = 1'b0;
                instr_o.yield = 1'b0;
