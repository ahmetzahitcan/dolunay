    ...
    always_comb begin
        ...
        case (undec_instr32_i) inside
            30'b000000000000000000100000000100: begin // WDONE
                ...
                instr_o.mem_loadstore = 'x;
                instr_o.mem_opsize = 'x;
                instr_o.mem_store_source = 'x;
                instr_o.mem_extendmode = 'x;
            ...
            default: begin // INVALID
                ...
                instr_o.alu_op1_sel = alu_op1_sel_e'('x);
                instr_o.alu_op2_sel = alu_op2_sel_e'('x);
                instr_o.branch_cond = branch_cond_e'('x);
                instr_o.wb_active = 'x;
                instr_o.wb_source = wb_source_e'('x);
                instr_o.barr_load = 'x;
                instr_o.barr_sync = 'x;
                instr_o.yield = 'x;
