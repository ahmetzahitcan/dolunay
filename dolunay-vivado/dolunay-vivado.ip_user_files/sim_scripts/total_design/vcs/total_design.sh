...
design_libs=(xpm xil_defaultlib axi_lite_ipif_v3_0_4 axi_uartlite_v2_0_39 blk_mem_gen_v8_4_12 proc_sys_reset_v5_0_17)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../bd/total_design/ipshared/a415" +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../bd/total_design/ipshared/a415" +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_12 $vlogan_opts +v2k +incdir+"../../../../../bd/total_design/ipshared/a415" +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.total_design xil_defaultlib.glbl -o total_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./total_design_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/azc/Belgeler/dolunay/tez-vivado/tez-vivado.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key total_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc total_design_simv.daidir vcs_lib c.obj)
