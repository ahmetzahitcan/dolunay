...
export RDI_DATADIR="/home/azc/Xilinx/2025.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L axi_uartlite_v2_0_39 -L blk_mem_gen_v8_4_12 -L proc_sys_reset_v5_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot total_design xil_defaultlib.total_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim total_design -key {Behavioral:sim_1:Functional:total_design} -tclbatch cmd.tcl -protoinst "protoinst_files/total_design.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/azc/Xilinx/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb total_design.wdb xsim.dir libdpi.so)
