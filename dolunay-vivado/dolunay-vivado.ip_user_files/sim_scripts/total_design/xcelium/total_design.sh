...
#
# Script generated by Vivado on Sun May 10 18:36:39 +03 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : total_design.sh
...
#
# Usage        : total_design.sh
#                total_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                total_design.sh [-rerun]
#                total_design.sh [-reset_run]
#                total_design.sh [-clean]
#                total_design.sh [-reset_log]
#                total_design.sh [-help]
#
...
#                script (type 'total_design.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname axi_uartlite_v2_0_39 -libname blk_mem_gen_v8_4_12 -libname proc_sys_reset_v5_0_17 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib axi_lite_ipif_v3_0_4 axi_uartlite_v2_0_39 blk_mem_gen_v8_4_12 proc_sys_reset_v5_0_17)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "total_design.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./total_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../bd/total_design/ipshared/a415" +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../bd/total_design/ipshared/a415" +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_12 $xmvlog_opts +incdir+"../../../../../bd/total_design/ipshared/a415" +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.total_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.total_design -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/azc/Belgeler/dolunay/tez-vivado/tez-vivado.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log total_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./total_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: total_design.sh [-help]\n\
Usage: total_design.sh [-step]\n\
Usage: total_design.sh [-lib_map_path]\n\
Usage: total_design.sh [-rerun]\n\
Usage: total_design.sh [-reset_run]\n\
Usage: total_design.sh [-clean]\n\
Usage: total_design.sh [-reset_log]\n\
Usage: total_design.sh [-keep_index]\n\
Usage: total_design.sh [-noclean_files]\n\n\
