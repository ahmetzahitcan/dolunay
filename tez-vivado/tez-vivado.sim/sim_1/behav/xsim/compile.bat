...
REM
REM Generated by Vivado on Tue Mar 10 13:39:30 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_shuffle_any_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_shuffle_any_vlog.prj -log xvlog.log
