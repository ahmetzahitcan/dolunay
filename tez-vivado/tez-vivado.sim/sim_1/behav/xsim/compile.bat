...
REM
REM Generated by Vivado on Wed Mar 25 18:38:32 +0300 2026
...
echo "xvlog --incr --relax -L uvm -prj test_control_unit_vlog.prj"
call xvlog  --incr --relax -L uvm -prj test_control_unit_vlog.prj -log xvlog.log
