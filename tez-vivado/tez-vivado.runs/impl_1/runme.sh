...
HD_PWD='P:/AZC/tez/tez-vivado/tez-vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log thread_scheduler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source thread_scheduler.tcl -notrace
