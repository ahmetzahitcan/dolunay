...
PY  - 2026/08/25
Y2  - 2026/09/25
TI  - Dolunay: Architectural Support for Independent Thread Scheduling in a RISC-V SIMT Accelerator
JF  - WiPiEC Journal - Works in Progress in Embedded Computing Journal
JA  - wipiec
VL  - 12
IS  - 2
SE  - Full Paper
...
Dolunay is still only a proof-of-concept, but is being actively developed in the `main` branch. The following animation shows how Dolunay executes conditional code, as well as its ability to multitask cooperatively via the `YIELD` custom instruction.
